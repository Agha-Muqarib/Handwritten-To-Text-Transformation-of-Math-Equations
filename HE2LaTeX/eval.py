...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/content/drive/My Drive/LaTeX-OCR-main/settings/config.yaml', help='path to yaml config file', type=argparse.FileType('r'))
    parser.add_argument('-c', '--checkpoint', default='/content/drive/My Drive/LaTeX-OCR-main/checkpoints/weights.pth', type=str, help='path to model checkpoint')
    parser.add_argument('-d', '--data', default='/content/drive/My Drive/LaTeX-OCR-main/dataset/data/val.pkl', type=str, help='Path to Dataset pkl file')
